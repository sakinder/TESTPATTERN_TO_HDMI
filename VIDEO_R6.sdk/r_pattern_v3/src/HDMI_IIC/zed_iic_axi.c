...
int zed_iic_axi_IicWrite( zed_iic_t *pIIC, Xuint8 ChipAddress, Xuint8 RegAddress, Xuint8 *pBuffer, Xuint8 ByteCount);
int zed_iic_axi_IicRead ( zed_iic_t *pIIC, Xuint8 ChipAddress, Xuint8 RegAddress, Xuint8 *pBuffer, Xuint8 ByteCount);
int zed_iic_axi_IicEWrite( zed_iic_t *pIIC, Xuint8 ChipAddress, Xuint16 RegAddress, Xuint8 *pBuffer, Xuint8 ByteCount);
int zed_iic_axi_IicERead ( zed_iic_t *pIIC, Xuint8 ChipAddress, Xuint16 RegAddress, Xuint8 *pBuffer, Xuint8 ByteCount);
/******************************************************************************
                                         ...
                                         Xuint8 *pBuffer, Xuint8 ByteCount)
{
  ...
  do
  {
    ...
    {
      SentByteCount = XIic_DynSend(pContext->CoreAddress, ChipAddress, (Xuint8 *)&RegAddress, 1,XIIC_REPEATED_START);
    }
    cnt++;
