...
entity VIDEO_R6_v_tpg_0_0_tpgPatternTartanClbW_rom is 
    generic(
             dwidth     : integer := 3; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of VIDEO_R6_v_tpg_0_0_tpgPatternTartanClbW_rom is 
...
entity VIDEO_R6_v_tpg_0_0_tpgPatternTartanClbW is
    generic (
        DataWidth : INTEGER := 3;
...
architecture arch of VIDEO_R6_v_tpg_0_0_tpgPatternTartanClbW is
    component VIDEO_R6_v_tpg_0_0_tpgPatternTartanClbW_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    VIDEO_R6_v_tpg_0_0_tpgPatternTartanClbW_rom_U :  component VIDEO_R6_v_tpg_0_0_tpgPatternTartanClbW_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
